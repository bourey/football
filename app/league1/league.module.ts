...
import { LeagueDetailComponent, resolveLeague } from './league_detail.component';

// Angular 1 module for the /leagues sub-directory
export const leagueModule = angular.module('leagueListModule', [
    'ngRoute',
]);
